  ...
  return (
    <div className="px-10 py-12 bg-white">
      ...
      <div className="flex justify-center gap-6">
        ...
        {/* MEN */}
        <div className="relative group h-[420px] w-[280px] overflow-hidden rounded-2xl cursor-pointer shadow-md hover:shadow-2xl transform transition duration-300 hover:-translate-y-2">
        ...
        <div className="group flex flex-col items-center justify-center h-[420px] w-[280px] bg-gradient-to-b from-green-400 to-green-600 hover:from-green-500 hover:to-green-700 transition-all duration-300 rounded-2xl text-white text-center p-6 shadow-md hover:shadow-2xl transform hover:-translate-y-2">
          ...
          <button className="mt-4 bg-transparent border-2 border-white text-white font-semibold px-6 py-2 rounded-full hover:bg-white hover:text-green-700 transition-all duration-200 text-sm">
            Shop Now
          </button>
        </div>
